<?php
	...
	$object = $storage->bucket("audio-to-text-storage")->object($objectName);
    ...
    <body>
        <div class="container">
        	<div class="py-5 text-center">
		        ...
		        <p class="lead">Analyzing Complete! Get Your Audio Transcript</p>
		    </div>
		</div>
			...
			<div class="py-5 text-center">
				<div class="row">
					<div class="col-md-12">
						...
						<br>
						<a href="index.php" class="btn btn-success">Convert New</a>
					</div>
				</div>
			</div>
		</div>
