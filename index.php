...
<body>
        ...
        <section class="experiment recordrtc">
            ...
            <div style="text-align: center; display: none;">
                ...
                <button id="upload-to-server">Convert To Text</button>
            </div>
        ...
        <script>
            ...
            recordingDIV.querySelector('button').onclick = function() {
                ...
                //     };
                // }
                recordingMedia = document.createElement("select");
                recordingMedia.innerHTML = '<option value="record-audio">record-audio</option>';
                console.log(recordingMedia);
                // console.log(recordingMedia.value == 'record-audio');
                    ...
                    button.mediaCapturedCallback = function() {
                        ...
                        button.recordingEndedCallback = function(url) {
                            ...
                            if(document.getElementsByTagName('audio').length>1){
                                recordingPlayer.parentNode.removeChild(document.getElementsByTagName('audio')[1]);
                                recordingPlayer.parentNode.removeChild(document.getElementsByTagName('hr')[0]);
                            }

                            // recordingPlayer.parentNode.removeChild(recordingPlayer.parentNode.childNodes[3]);
                            recordingPlayer.parentNode.appendChild(document.createElement('hr'));
